...
% better use of graphs as a resource for annotation and information curation
%    coordinate formalisms? visualization?
% conditional annotation
% convergence with evolutionary and comparative genomics
% increasing scope of organisms (already happening)

%TODO:
% conditional annotation
% differentiate between roles for reference:
%    description of population variation
%    technical tool for read mapping
%    informatic object for annotations
% application to complex regions
% increasing scope of organisms (already happening)
% application to more areas of functional genomics
%    will the graph formalism be sufficient? what about e.g. pangenome of 3-d conformation
%    something about the danger of becoming graph-oriented rather than task-oriented
% a lot of what pangenomics does is bring formal rigor to population genomic consideration of variation (homology map)
% what kind of population genomics do we support
%    will it be necessary to go beyond linear models
%    maybe cite the frequented regions paper? chaisson VNTR paper?
%    this will need to be a conversation with pop gen, involve new formalisms
% how will the logic of "variants" generalize to these complex graphs 
% convergence with evolutionary and comparative genomics
% better use of graphs as a resource for annotation and information curation
%    coordinate formalisms? visualization?
